...
import duotone from '../duotone/Unite'
import fill from '../fill/Unite'
import light from '../light/Unite'
import regular from '../regular/Unite'
import thin from '../thin/Unite'

function Unite({ weight, color, size, style, mirrored, duotoneColor, duotoneOpacity, ...props }: IconProps) {
  const {
