...
const Moon = ({
  ...
  className: "moon-bold__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-moon-bold',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
