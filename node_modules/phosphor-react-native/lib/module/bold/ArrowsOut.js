...
const ArrowsOut = ({
  ...
  className: "arrows-out-bold__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-arrows-out-bold',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
