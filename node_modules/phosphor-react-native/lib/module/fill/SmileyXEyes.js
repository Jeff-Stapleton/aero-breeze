...
const SmileyXEyes = ({
  ...
  className: "smiley-x-eyes-fill__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-smiley-x-eyes-fill',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
