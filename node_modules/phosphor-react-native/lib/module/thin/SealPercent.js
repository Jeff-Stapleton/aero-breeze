...
const SealPercent = ({
  ...
  className: "seal-percent-thin__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-seal-percent-thin',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
