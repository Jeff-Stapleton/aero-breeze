...
const Selection = ({
  ...
  className: "selection-light__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-selection-light',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
