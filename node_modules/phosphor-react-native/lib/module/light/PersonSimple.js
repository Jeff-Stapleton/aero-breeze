...
const PersonSimple = ({
  ...
  className: "person-simple-light__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-person-simple-light',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
