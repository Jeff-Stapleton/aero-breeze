...
const Sun = ({
  ...
  className: "sun-light__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-sun-light',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
