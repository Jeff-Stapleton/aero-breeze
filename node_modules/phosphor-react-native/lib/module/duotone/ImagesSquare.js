...
const ImagesSquare = ({
  ...
  className: "images-square-duotone__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-images-square-duotone',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
