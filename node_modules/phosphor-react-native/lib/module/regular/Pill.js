...
const Pill = ({
  ...
  className: "pill__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-pill',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
