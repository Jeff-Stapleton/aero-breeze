...
const SquaresFour = ({
  ...
  className: "squares-four-duotone__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-squares-four-duotone',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
