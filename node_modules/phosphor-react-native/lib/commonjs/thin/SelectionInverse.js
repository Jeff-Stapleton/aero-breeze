...
const SelectionInverse = ({
  ...
  className: "selection-inverse-thin__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-selection-inverse-thin',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
