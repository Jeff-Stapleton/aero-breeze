...
const Queue = ({
  ...
  className: "queue-thin__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-queue-thin',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
