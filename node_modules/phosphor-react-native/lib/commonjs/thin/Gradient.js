...
const Gradient = ({
  ...
  className: "gradient-thin__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-gradient-thin',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
