...
const Usb = ({
  ...
  className: "usb-thin__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-usb-thin',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
