...
const GooglePodcastsLogo = ({
  title,
  titleId,
  ...props
}) => /*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactNativeSvg.default, {
  className: "google-podcasts-logo-thin__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-google-podcasts-logo-thin',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
