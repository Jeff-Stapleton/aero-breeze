...
const SuitcaseRolling = ({
  ...
  className: "suitcase-rolling-bold__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-suitcase-rolling-bold',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
