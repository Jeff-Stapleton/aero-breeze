...
const Toolbox = ({
  ...
  className: "toolbox-bold__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-toolbox-bold',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
