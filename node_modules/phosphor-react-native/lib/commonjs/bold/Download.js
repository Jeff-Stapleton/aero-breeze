...
const Download = ({
  ...
  className: "download-bold__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-download-bold',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
