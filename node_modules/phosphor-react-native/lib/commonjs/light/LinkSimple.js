...
const LinkSimple = ({
  ...
  className: "link-simple-light__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-link-simple-light',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
