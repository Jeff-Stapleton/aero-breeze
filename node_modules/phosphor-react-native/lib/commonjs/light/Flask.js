...
const Flask = ({
  ...
  className: "flask-light__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-flask-light',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
