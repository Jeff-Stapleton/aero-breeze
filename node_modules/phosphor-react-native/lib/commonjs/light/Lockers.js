...
const Lockers = ({
  ...
  className: "lockers-light__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-lockers-light',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
