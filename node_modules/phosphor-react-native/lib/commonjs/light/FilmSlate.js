...
const FilmSlate = ({
  ...
  className: "film-slate-light__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-film-slate-light',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
