...
const DotsNine = ({
  ...
  className: "dots-nine-light__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-dots-nine-light',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
