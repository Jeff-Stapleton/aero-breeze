...
const Aperture = ({
  ...
  className: "aperture-light__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-aperture-light',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
