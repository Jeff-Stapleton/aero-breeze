...
const Nut = ({
  ...
  className: "nut-light__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-nut-light',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
