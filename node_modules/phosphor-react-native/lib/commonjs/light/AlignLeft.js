...
const AlignLeft = ({
  ...
  className: "align-left-light__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-align-left-light',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
