...
const ClockCountdown = ({
  ...
  className: "clock-countdown-fill__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-clock-countdown-fill',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
