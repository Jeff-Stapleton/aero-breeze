...
const Selection = ({
  ...
  className: "selection-fill__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-selection-fill',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
