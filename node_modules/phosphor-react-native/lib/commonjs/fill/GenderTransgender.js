...
const GenderTransgender = ({
  ...
  className: "gender-transgender-fill__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-gender-transgender-fill',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
