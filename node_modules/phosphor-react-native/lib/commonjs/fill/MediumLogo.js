...
const MediumLogo = ({
  ...
  className: "medium-logo-fill__svg-icon-phosphor",
  testID: props.testID ?? 'phosphor-react-native-medium-logo-fill',
  fill: "currentColor",
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size,
